  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> I'm Ervinismu.
          </BigTitle>
          <Subtitle>I created a modern web and application to solve your problem in an amazing way</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="Github"
              link="https://github.com/ervinismu"
              bg="linear-gradient(to right, #0d0d0d 0%, #808080 100%)"
            >
              Lessons, tutorials and open source projects that I have written.
            </ProjectCard>
            <ProjectCard
              title="Linkedin"
              link="https://www.linkedin.com/in/ervien-ismunandar-susila"
              bg="linear-gradient(to right, #004d99 0%, #80bfff 100%)"
            >
              Description of my professional profile.
            </ProjectCard>
            <ProjectCard
              title="Medium"
              link="http://medium.com/@ervinismu"
              bg="linear-gradient(to right, #39ac39 0%, #17b9aa 100%)"
            >
              This is an article that I wrote to share about experience and tutorials on coding.
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          ...
          <AboutDesc>
            Having more than 1 year experience as a programmer, I use linux operating system for every day and almost 
            every day I write ruby code with Ruby on Rails framework and sometimes write Go code. I was able to research 
            and test new technology, learn fast, and adapt early. I have good communication skills and try to share my knowledge.
          </AboutDesc>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:social.ervin@gmail.com">Hi</a> or find me on other platforms:{' '}
            <a href="https://www.instagram.com/ervinismu">Instagram</a>
          </ContactText>
        </Inner>
        <Footer>
